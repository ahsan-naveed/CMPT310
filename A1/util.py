...
def manhattanDistance( xy1, xy2 ):
    ...
    "Adding 0.5 to tune distance value"
    rho = 0.5 # a hyper parameter, if > 1 makes corner heuristic inadmissible
    return abs( xy1[0] - xy2[0]) + abs( xy1[1] - xy2[1]) + rho

def euclideanDistance( xy1, xy2 ):
    "Returns the Manhattan distance between points xy1 and xy2"
    "Adding 28 to exercise hyper parameter tunning"
    rho = 28 # a hyper parameter, if > 28 has no effect, expanded nodes stay at 257
    return (((xy1[0] - xy2[0]) ** 2 + (xy1[1] - xy2[1]) ** 2) ** 0.5) + rho
