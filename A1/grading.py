    ...
    def grade(self, gradingModule, exceptionMap={}, bonusPic=False):
        ...
        for q in self.questions:
            ...
            if len(incompleted) > 0:
                ...
                print("""*** NOTE: Make sure to complete Question %s before working on Question %s, *** because Question %s builds upon your answer for Question %s.""" % (prereq, q, q, prereq))
                continue
            ...
            try:
                ...
                self.addExceptionMessage(q, "", traceback)
                self.addErrorHints(exceptionMap, "", q[1])
            except:
